...
async def send_document_with_chat_id(client, sender, path, caption, thumb_path, upm):
    ...
    try:
        await client.send_document(
            ...
            progress_args=(
                client,
                '**__Uploading:__**\n**__Bot made by [MR RAJ BOTS HUB](https://t.me/BOTS_DUNIYA)__**',
                upm,
                time.time()
            )
        )
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[MR RAJ BOTS HUB](https://t.me/BOTS_DUNIYA)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[MMR RAJ BOTS HUB](https://t.me/BOTS_DUNIYA)**__" if msg.caption else "__Unrestricted by **[MR RAJ BOTS HUB](https://t.me/BOTS_DUNIYA)**__"
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[MR RAJ BOTS HUB](https://t.me/BOTS_DUNIYA)**__" if msg.caption else "__Unrestricted by **[Team SPY](https://t.me/dev_gagan)**__"
